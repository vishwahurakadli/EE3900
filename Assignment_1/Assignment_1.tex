...
\begin{align}
\vec{I} = \frac{m\times\vec{A} + n\times\vec{B}}{m + n}
\end{align}
so for ratio 2 : 1 R will be given by
\begin{align}
\vec{R} = \frac{2\times(3\vec{a} - 2\vec{b}) + (\vec{a} + \vec{b})}{2 + 1}\\
\vec{R} = \frac{7\vec{a}}{3} - \vec{b}
\end{align}
will divide PQ internally\\
\item similarly section formula for external division for ration m : n is given by
\begin{align}
\vec{E} = \frac{m\times\vec{A} - n\times\vec{B}}{m - n}
\end{align}
so for ratio 2 : 1 R will be given by
\begin{align}
\vec{R} = \frac{2\times(3\vec{a} - 2\vec{b}) - (\vec{a} + \vec{b})}{2 - 1}\\
